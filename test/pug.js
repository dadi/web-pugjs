...
describe('Pug.js interface', function () {
  ...
  it('should declare .pug as a supported extension', done => {
    factory.metadata.extensions.indexOf('.pug').should.not.equal(-1)
  ...
  it('should load pages', done => {
    ...
    Promise.resolve(instance.initialise()).then(() => {
      ...
      (typeof instance.templates.products).should.eql('function')
